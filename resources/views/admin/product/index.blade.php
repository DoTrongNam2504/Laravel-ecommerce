...
<div class="content-wrapper">
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <a href="{{ url('add-product') }}" class="btn btn-info btn-lg btn-block">
                                ...
                                @foreach ($productAdmin as $row)
                                    <tr class="table-info">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('edit-product/'.$row->id)}}" class="btn btn-dark btn-icon-text"> Edit <i
                                                    class="mdi mdi-table-edit btn-icon-append icon-top-3px"></i>
                                            </a>

                                            <a href="{{url('delete-product/'.$row->id)}}" class="btn btn-dark btn-icon-text"> Delete <i
